\doxysection{numerical\+\_\+methods/ode\+\_\+semi\+\_\+implicit\+\_\+euler.cpp File Reference}
\hypertarget{ode__semi__implicit__euler_8cpp}{}\label{ode__semi__implicit__euler_8cpp}\index{numerical\_methods/ode\_semi\_implicit\_euler.cpp@{numerical\_methods/ode\_semi\_implicit\_euler.cpp}}


Solve a multivariable first order \href{https://en.wikipedia.org/wiki/Ordinary_differential_equation}{\texttt{ ordinary differential equation (ODEs)}} using \href{https://en.wikipedia.org/wiki/Semi-implicit_Euler_method}{\texttt{ semi implicit Euler method}}  
...
\item 
void \mbox{\hyperlink{ode__semi__implicit__euler_8cpp_abaeae8f62a018d197f0187a1c80a90fe}{problem}} (const double \&x, std\+::valarray$<$ double $>$ \texorpdfstring{$\ast$}{*}y, std\+::valarray$<$ double $>$ \texorpdfstring{$\ast$}{*}dy)
...
void \mbox{\hyperlink{ode__semi__implicit__euler_8cpp_af3adf7b092a87868917ee5fb4255192b}{exact\+\_\+solution}} (const double \&x, std\+::valarray$<$ double $>$ \texorpdfstring{$\ast$}{*}y)
...
\begin{DoxyCompactList}\small\item\em Compute approximation using the semi-\/implicit-\/\+Euler method in the given limits. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{ode__semi__implicit__euler_8cpp_aa13517b8e5de1b75592052db7f7e237f}{save\+\_\+exact\+\_\+solution}} (const double \&X0, const double \&X\+\_\+\+MAX, const double \&step\+\_\+size, const std\+::valarray$<$ double $>$ \&Y0)
\item 
int \mbox{\hyperlink{ode__semi__implicit__euler_8cpp_a0ddf1224851353fc92bfbff6f499fa97}{main}} (int argc, char \texorpdfstring{$\ast$}{*}argv\mbox{[}$\,$\mbox{]})
...
The ODE being solved is\+:      \begin{eqnarray*}
   ...
   u(x) &=& \cos(x)\\
   v(x) &=& -\sin(x)\\
   \end{eqnarray*} The computation results are stored to a text file {\ttfamily semi\+\_\+implicit\+\_\+euler.\+csv} and the exact soltuion results in {\ttfamily exact.\+csv} for comparison. 

To implement \href{https://en.wikipedia.org/wiki/Van_der_Pol_oscillator}{\texttt{ Van der Pol oscillator}}, change the \doxylink{ode__semi__implicit__euler_8cpp_abaeae8f62a018d197f0187a1c80a90fe}{problem} function to\+: 
\begin{DoxyCode}{0}
...
\doxylink{ode__midpoint__euler_8cpp}{ode\+\_\+midpoint\+\_\+euler.\+cpp}, \doxylink{ode__forward__euler_8cpp}{ode\+\_\+forward\+\_\+euler.\+cpp} 
\end{DoxySeeAlso}


\doxysubsection{Function Documentation}
\Hypertarget{ode__semi__implicit__euler_8cpp_af3adf7b092a87868917ee5fb4255192b}\index{ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}!exact\_solution@{exact\_solution}}
\index{exact\_solution@{exact\_solution}!ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}}
\doxysubsubsection{\texorpdfstring{exact\_solution()}{exact\_solution()}}
{\footnotesize\ttfamily \label{ode__semi__implicit__euler_8cpp_af3adf7b092a87868917ee5fb4255192b} 
...
\end{DoxyCode}
\Hypertarget{ode__semi__implicit__euler_8cpp_a0ddf1224851353fc92bfbff6f499fa97}\index{ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}!main@{main}}
\index{main@{main}!ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}}
\doxysubsubsection{\texorpdfstring{main()}{main()}}
{\footnotesize\ttfamily \label{ode__semi__implicit__euler_8cpp_a0ddf1224851353fc92bfbff6f499fa97} 
...
\DoxyCodeLine{00193\ \ \ \ \ \textcolor{keywordtype}{double}\ step\_size;}
\DoxyCodeLine{00194\ }
...
\DoxyCodeLine{00204\ \ \ \ \ \textcolor{keywordtype}{double}\ total\_time\ =\ \mbox{\hyperlink{group__ode_ga3874d294ab00fe9ce8731c5b7991a089}{semi\_implicit\_euler}}(step\_size,\ X0,\ X\_MAX,\ \&Y0,\ \textcolor{keyword}{true});}
...
\DoxyCodeLine{00208\ \ \ \ \ \mbox{\hyperlink{ode__semi__implicit__euler_8cpp_aa13517b8e5de1b75592052db7f7e237f}{save\_exact\_solution}}(X0,\ X\_MAX,\ step\_size,\ Y0);}
\DoxyCodeLine{00209\ }
\DoxyCodeLine{00210\ \ \ \ \ \textcolor{keywordflow}{return}\ 0;}
\DoxyCodeLine{00211\ \}}

\end{DoxyCode}
\Hypertarget{ode__semi__implicit__euler_8cpp_abaeae8f62a018d197f0187a1c80a90fe}\index{ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}!problem@{problem}}
\index{problem@{problem}!ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}}
\doxysubsubsection{\texorpdfstring{problem()}{problem()}}
{\footnotesize\ttfamily \label{ode__semi__implicit__euler_8cpp_abaeae8f62a018d197f0187a1c80a90fe} 
...
\end{DoxyCode}
\Hypertarget{ode__semi__implicit__euler_8cpp_aa13517b8e5de1b75592052db7f7e237f}\index{ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}!save\_exact\_solution@{save\_exact\_solution}}
\index{save\_exact\_solution@{save\_exact\_solution}!ode\_semi\_implicit\_euler.cpp@{ode\_semi\_implicit\_euler.cpp}}
\doxysubsubsection{\texorpdfstring{save\_exact\_solution()}{save\_exact\_solution()}}
{\footnotesize\ttfamily \label{ode__semi__implicit__euler_8cpp_aa13517b8e5de1b75592052db7f7e237f} 
...
\DoxyCodeLine{00170\ \ \ \ \ \ \ \ \ \ \ \ \ fp\ <<\ y[i]\ <<\ \textcolor{stringliteral}{"{},"{}};}
\DoxyCodeLine{00171\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00172\ \ \ \ \ \ \ \ \ fp\ <<\ y[y.size()\ -\/\ 1]\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}};}
\DoxyCodeLine{00173\ }
\DoxyCodeLine{00174\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{ode__semi__implicit__euler_8cpp_af3adf7b092a87868917ee5fb4255192b}{exact\_solution}}(x,\ \&y);}
\DoxyCodeLine{00175\ }
